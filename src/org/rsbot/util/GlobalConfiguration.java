...
public class GlobalConfiguration {
	...
	public static class Paths {
		...
		public static class URLs {
			...
			public static final String UPDATER = "http://updater." + DOMAIN + "/";
			...
			public static final String PROJECT = "http://dev." + DOMAIN + "/projects/show/rsbot";
			public static final String SITE = "http://www." + DOMAIN;
		}
